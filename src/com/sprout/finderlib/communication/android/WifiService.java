 ...
 *
 */
public class WifiService extends AbstractAndroidCommunicationService {
...
//    if (D) Log.d(TAG, "connect to: " + device);
  ...
  public void discoverPeers(final Callback callback) {
      ...
      mResolveListener = new NsdManager.ResolveListener() {
        ...
        public void onServiceResolved(NsdServiceInfo serviceInfo) {
            ...
            Device peer = new Device(serviceInfo.getServiceName(), serviceInfo.getHost().getHostName());
  ...
  public Device getSelf() {
    ...
    return new Device(serviceInfo.getServiceName(), serviceInfo.getHost().getHostName());
  }
