...
public class BluetoothService extends AbstractAndroidCommunicationService {	
  // Debugging
  ...
  public synchronized void connected(BluetoothSocket socket, BluetoothDevice
    ...
    bundle.putSerializable(DEVICE, new Device(device.getName(), device.getAddress()));
    msg.setData(bundle);
  ...
  public Set<Device> bondedPeers() {
    ...
    for(BluetoothDevice device: mAdapter.getBondedDevices()){
      ans.add(new Device(device.getName(), device.getAddress()));
    }
    return ans;
  }
